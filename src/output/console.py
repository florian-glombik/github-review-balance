"""Console output functions for OutputFormatter."""

from typing import Dict, Set

from ..models import ReviewStats
from .formatter_base import GREEN, YELLOW, RED, CYAN, BOLD, RESET
...
def _print_open_prs(
    ...
    for author, prs in authors_with_prs:
        ...
        for pr in prs:
            ...
            if requested_my_review:
                indicators.append(f"{CYAN}{BOLD}\U0001f449 [REVIEW REQUESTED]{RESET}")
...
def _print_detailed_history(
    ...
    for user in sorted_users:
        ...
        # List PRs I reviewed
        if my_reviews.prs:
            print(f"\n\U0001f4dd PRs I reviewed ({len(my_reviews.prs)}):")
        ...
        if their_reviews.prs:
            print(f"\n\U0001f4dd PRs they reviewed ({len(their_reviews.prs)}):")
